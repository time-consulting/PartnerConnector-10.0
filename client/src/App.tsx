...
const SubmitReferral = lazy(() => import("@/pages/submit-deals?"));
...
const TrackReferrals = lazy(() => import("@/pages/track-deals?"));
...
const QuickAddReferral = lazy(() => import("@/pages/quick-add-deals?"));
...
function AppRoutes() {
  return (
    <Switch>
      ...
      <Route path="/submit-deals?" component={() => <PrivateRoute><SubmitReferral /></PrivateRoute>} />
      <Route path="/quick-add-deals?" component={() => <PrivateRoute><QuickAddReferral /></PrivateRoute>} />
      ...
      <Route path="/track-deals?" component={() => <PrivateRoute><TrackReferrals /></PrivateRoute>} />
