...
function AppRoutes() {
  return (
    <Switch>
      ...
      <Route path="/program-management" component={() => <PrivateRoute><ProgramManagement /></PrivateRoute>} />
      <Route path="/analytics-reporting" component={() => <PrivateRoute><AnalyticsReporting /></PrivateRoute>} />
