...
export default function QuoteSystem({ isOpen, onClose, onApprove, referral }: QuoteSystemProps) {
  ...
  const monthlyVolume = parseInt(referral.monthlyVolume?.replace(/[£,]/g, '') || '50000');
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2 text-2xl">
            ...
            Competitive Quote Ready - {referral.businessName}
          </DialogTitle>
        </DialogHeader>
