...
This ensures fair compensation based on the long-term value each deal brings to our partners.
...
4. **Week 4**: Submit your first Dojo deal and track commission
...
- **Commission Dashboard**: Real-time tracking of all your Dojo deal
...
While direct funding deal provide upfront commissions, focus on team building to create consistent monthly income through the 20% and 10% ongoing structure.
...
Your PartnerConnector dashboard is your command center for managing deal, tracking commissions, and building your partner network.
...
- **Submit New Deal**: Quick deal submission
- **Track Status**: Real-time deal progress
...
`
    ...
    {
      id: 'deal-submission-process',
      title: 'Referral Submission & Tracking System',
      description: 'Step-by-step guide to submitting and managing client deal',
      duration: '12 min',
      difficulty: 'Beginner',
      type: 'interactive',
      completed: false,
...
**Before submitting any deal**, ensure the client meets our criteria:
...
#### Dashboard Tracking:
- **Status Updates**: Real-time deal progress
...
→ Review feedback and understand why - use this learning for future deal
...
- **Commission Value**: Average £400+ per deal

#### Weekly Goals:
- **Qualified Conversations**: 10 potential clients
- **Referral Submissions**: 3-4 quality deal
- **Follow-up Actions**: Complete all dashboard tasks
- **Success Rate**: 2-3 approvals per week

Remember: Quality over quantity. One well-qualified, properly submitted deal is worth more than five poor-quality submissions.
`
    },
    {
      id: 'gdpr-compliance',
...
- Business deal data must only be used for processing applications
...
#### Data Collection:
✅ Only collect information necessary for deal
...
✅ Delete local copies once deal is submitted
...
*Completion of this module is required before you can submit deal.*
...
### Data Collection
- Only collect data necessary for processing deal
...
□ Ensure data is necessary for the deal process
...
- Submit deal through our platform
...
- **Payment Processing**: Upfront commissions on successful deal
- **Business Funding**: £300-£1,500 per successful deal
...
- **Business Funding**: £400-£2,000 per successful deal
- **Requirements**: 10+ successful deal, advanced certification

### Level 3 Partners (Gold/Extended Network)
- **Payment Processing**: 10% ongoing commission from extended network
- **Business Funding**: £500-£2,500 per successful deal
- **Requirements**: 25+ successful deal, master certification
...
Business funding is one of our highest-commission services, with potential earnings of £300-£2,500 per successful deal. Understanding how to identify, qualify, and present funding opportunities is essential for maximizing your income.
...
- Ask for deal to other businesses
...
### Referral Generation
- Ask satisfied clients for deal
- Offer deal incentives
