...
interface WeeklyTask {
  ...
  completed: boolean;
  dueDate: string;
  category: 'leads' | 'deal' | 'training' | 'follow-up' | 'custom';
  reminderSet: boolean;
}
...
export default function WeeklyTasks() {
  ...
  useEffect(() => {
    const defaultTasks: WeeklyTask[] = [
      ...
      {
        id: '3',
        title: 'Submit 2 deal applications',
        description: 'Convert qualified leads into active deal',
        priority: 'high',
        completed: false,
        dueDate: getWeekEndDate(),
        category: 'deal',
  ...
  const getCategoryIcon = (category: string) => {
    switch (category) {
      ...
      case 'deal': return <TrendingUpIcon className="w-4 h-4" />;
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="deal">Referrals</option>
