...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed z-50 grid gap-4 border border-gray-200 bg-white shadow-xl duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95",
        // Default positioning and sizing
        "left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%]",
        // Default padding and rounded corners
        "p-6 rounded-lg",
        // Allow custom width through className prop
        className
      )}
      {...props}
    >
