          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card className="text-center p-8 border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-0">
                ...
                <p className="text-gray-600 mb-6">
                  Begin submitting deal and watch your revenue grow. Our platform 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="text-center p-6 bg-white border-0 shadow-lg">
              <CardContent className="p-0">
                ...
                <p className="text-sm text-gray-600">Earn up to £2,000 per successful deal with our competitive commission structure</p>
              </CardContent>
            </Card>
