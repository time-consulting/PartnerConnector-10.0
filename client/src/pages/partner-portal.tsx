          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="p-8 border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-0 text-center">
                ...
                <p className="text-gray-600 mb-6">
                  Monitor your referral performance, conversion rates, and revenue trends with interactive charts and analytics.
                </p>
            ...
            <Card className="p-8 border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-0 text-center">
                ...
                <p className="text-gray-600 mb-6">
                  Submit new referrals, track existing ones, and manage client relationships all in one place.
                </p>
                <ul className="text-left text-sm text-gray-600 space-y-2">
                  <li className="flex items-center gap-2">
                    <CheckIcon className="w-4 h-4 text-green-600" />
            ...
            <Card className="p-8 border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-0 text-center">
                ...
                <p className="text-gray-600 mb-6">
                  Stay informed with intelligent notifications about referral updates, commission payments, and opportunities.
                </p>
                <ul className="text-left text-sm text-gray-600 space-y-2">
                  <li className="flex items-center gap-2">
                    <CheckIcon className="w-4 h-4 text-green-600" />
