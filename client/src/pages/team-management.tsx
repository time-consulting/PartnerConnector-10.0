...
export default function TeamManagement() {
  ...
  const { data: dealsStats, isLoading: isLoadingStats, refetch: refetchStats } = useQuery<InviteMetrics>({
  ...
  const inviteMetrics: InviteMetrics = dealsStats || {
    teamMembers: 0,
    registered: 0,
    active: 0
  };
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <div className="lg:ml-16">
              ...
              <div className="xl:col-span-8">
                <Tabs defaultValue="progression" className="w-full">
                  ...
                  <TabsContent value="deals-links" className="space-y-6">
                    <ReferralLinkManager 
                      userReferralCode={typedUser?.dealsCode || ''}
                      links={[]}
        ...
        <MobileShareSheet 
          ...
          dealsUrl={`${window.location.origin}/signup?ref=${typedUser?.id || 'demo123'}`}
          userStats={{
