...
import ReferralLinkManager from "@/components/deal-link-manager";
...
export default function TeamManagement() {
  ...
  const { data: dealStats, isLoading: isLoadingStats, refetch: refetchStats } = useQuery<InviteMetrics>({
    queryKey: ['/api/team/deal-stats'],
    enabled: isAuthenticated,
  });

  const { data: teamReferrals, isLoading: isLoadingReferrals, refetch: refetchReferrals } = useQuery<any[]>({
    queryKey: ['/api/team/deal'],
    enabled: isAuthenticated,
  });

  const inviteMetrics: InviteMetrics = dealStats || {
    teamMembers: 0,
    registered: 0,
    active: 0
  };
  ...
  const createLinkMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['/api/deal-links'] });
      toast({
        title: "Link Created",
    ...
    onError: (error: unknown) => {
      ...
      toast({
        title: "Error",
        description: "Failed to create deal link",
        variant: "destructive",
      });
    },
  });
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <div className="lg:ml-16">
              ...
              <div className="xl:col-span-8">
                <Tabs defaultValue="progression" className="w-full">
                  <TabsList className="grid w-full grid-cols-3 mb-6">
                    ...
                    <TabsTrigger value="deal-links" className="flex items-center gap-2" data-testid="tab-deal-links">
                  ...
                  <TabsContent value="deal-links" className="space-y-6">
                    <ReferralLinkManager 
                      userReferralCode={typedUser?.dealCode || ''}
                      links={[]}
                          ...
                          <>
                            <div className="flex justify-between items-center">
                              <div>
                                ...
                                <p className="text-xs text-gray-400">People who signed up with your deal code</p>
                              </div>
        ...
        <MobileShareSheet 
          ...
          dealUrl={`${window.location.origin}/signup?ref=${typedUser?.id || 'demo123'}`}
          userStats={{
