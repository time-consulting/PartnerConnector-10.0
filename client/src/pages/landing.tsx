    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="animate-fadeIn text-center lg:text-left">
                <Badge className="mb-4 bg-blue-500/20 text-blue-300 border border-blue-400/30 hover:bg-blue-500/30" data-testid="badge-welcome-back">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <Link href="/opportunities">
                    <Card className="tech-card p-4 cursor-pointer border-l-4 border-l-blue-500">
                  ...
                  <Link href="/track-deals">
                    <Card className="tech-card p-4 cursor-pointer border-l-4 border-l-emerald-500">
                      <div className="flex items-center gap-3">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="animate-fadeIn">
              <Badge className="mb-6 bg-blue-500/20 text-blue-300 border border-blue-400/30 hover:bg-blue-500/30" data-testid="badge-trusted">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-12">
                ...
                <Button 
                  variant="outline" 
                  size="lg"
                  className="border-2 border-blue-400/50 text-blue-300 hover:bg-blue-500 hover:text-white hover:border-blue-500 px-8 py-4 text-lg font-semibold transition-all duration-300"
            ...
            <div className="relative animate-fadeIn">
              <Card className="tech-card overflow-hidden bg-gradient-to-br from-blue-500 to-purple-600">
                <CardContent className="p-8 relative aspect-video flex items-center justify-center">
              ...
              <div className="absolute -bottom-6 -right-6 tech-card rounded-xl p-4">
      ...
      <section id="platform-features" className="py-20 relative">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <Badge className="mb-4 bg-blue-500/20 text-blue-300 border border-blue-400/30">PARTNERSHIP SOLUTIONS</Badge>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {/* Connect Clients */}
            <Card className="tech-card text-center p-6">
          ...
          <div className="text-center mt-12">
            ...
            <Button 
              variant="outline"
              size="lg"
              className="ml-4 border-blue-400/50 text-blue-300 hover:bg-blue-500 hover:text-white hover:border-blue-500 px-8 py-4"
            >
              Platform features
              <ArrowRightIcon className="ml-2 w-5 h-5" />
            </Button>
      ...
      <section className="py-20 relative">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <Badge className="mb-4 bg-emerald-500/20 text-emerald-300 border border-emerald-400/30">TRUSTED BY PROFESSIONALS</Badge>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  <CheckIcon className="w-5 h-5 text-emerald-400" />
                  <span className="text-gray-300">Multi-level commission tracking</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <Card className="tech-card p-6 text-center">
                <TrendingUpIcon className="w-12 h-12 text-emerald-600 mx-auto mb-4" />
              ...
              <Card className="tech-card p-6 text-center">
                <DollarSignIcon className="w-12 h-12 text-amber-600 mx-auto mb-4" />
      ...
      {/* Footer */}
      <footer className="bg-slate-950 text-gray-300 py-16 border-t border-white/5">
