        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              Get complete visibility into your deal pipeline with real-time tracking, 
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Follow your deal through every stage of the process</p>
          </div>
                ...
                <Card className="lg:ml-auto p-8 border-0 shadow-lg max-w-md">
                  <CardContent className="p-0">
                    ...
                    <p className="text-gray-600 mb-4">
                      Your deal is submitted and enters our verification process. 
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                ...
                <Card className="lg:order-2 p-8 border-0 shadow-lg max-w-md">
                  <CardContent className="p-0">
                    ...
                    <p className="text-gray-600 mb-4">
                      Our team reviews the deal details and contacts the client 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="p-6 bg-white border-0 shadow-lg text-center hover:shadow-xl transition-shadow">
              <CardContent className="p-0">
                ...
                <p className="text-sm text-gray-600">
                  Get notified immediately when your deal status changes or action is required
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="p-6 bg-white border-0 shadow-lg text-center hover:shadow-xl transition-shadow">
              <CardContent className="p-0">
                ...
                <p className="text-sm text-gray-600">
                  Track conversion rates, commission trends, and identify your best-performing deal sources
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="p-6 bg-white border-0 shadow-lg text-center hover:shadow-xl transition-shadow">
              <CardContent className="p-0">
                ...
                <p className="text-sm text-gray-600">
                  Visualize the complete journey of each deal with timestamps and milestones
                </p>
              </CardContent>
            </Card>
          </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-700">Real-time deal status updates</span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircleIcon className="w-5 h-5 text-green-600" />
      ...
      <section className="py-20 bg-gradient-to-r from-purple-600 to-blue-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-purple-100 mb-8">
            Start tracking your deal with complete transparency and real-time updates
          </p>
          <Button 
            size="lg"
