      ...
      <div className="lg:ml-16">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mb-4" data-testid="text-quotes-description">
            Review and manage quotes from Dojo for your client deal
          </p>
          ...
          <Card className="border-2 border-dashed" data-testid="card-empty-state">
            <CardContent className="py-12 text-center">
              ...
              <p className="text-gray-600 max-w-md mx-auto">
                When Dojo sends you a quote for your client deal, they'll appear here for you to review and approve.
              </p>
            </CardContent>
          </Card>
        ) : (
